...
{
    [SerializeField] private TMP_Text timerTextstart;
    [SerializeField] private TMP_Text timerTextmid;
    [SerializeField] private TMP_Text timerTextstop;
    private float TempoTrascorso;
    private float TempoTot;
    //EDITABLE FIELDS
    ...
    private void StartCalibration()
    {
        ...
        timerTextstart.text = (1f/Time.deltaTime).ToString();
        _isCalibrating = true;
    ...
    {
        timerTextmid.text = (1f/Time.deltaTime).ToString();
    ...
    public void FinishCalibration()
    {
        ...
        timerTextstop.text = (1f/Time.deltaTime).ToString();
    }
}
